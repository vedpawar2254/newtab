...
- [x] **UX-03**: User can toggle focus mode (hides sidebar, todo panel, quotes — only editor visible)
- [x] **UX-04**: User can search across all notes with full-text search
- [x] **UX-05**: Full keyboard navigation across the app
- [x] **UX-06**: All interactions feel smooth with appropriate animations and transitions
